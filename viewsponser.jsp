...
<p align="center" style="color:red; font-size:24px">
  ...
  <p align="center">Search Sponser</p>
  <p align="center">Search by City
    <select name="s1">
	<% 
 rst=stmt.executeQuery("select distinct address from sponser  ");
  while(rst.next()){
...
<table width="1076" border="0"  align="center">
  ...
  rst=stmt.executeQuery("select * from sponser where address='"+request.getParameter("s1")+"'");
  while(rst.next()){
