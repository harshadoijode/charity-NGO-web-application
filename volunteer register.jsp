...
<div class="logindiv">
  <form action="" method="post">
    ...
    <input type="text"  name="r13" placeholder="email" required>
...
String s13=request.getParameter("r13");
String s10=request.getParameter("r10");
try{
int x=stmt.executeUpdate("insert into valenters(firstname,lastname,age,address,phone,email,username,password,gender,ngo) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s13+"','"+s6+"','"+s7+"','"+s8+"','"+s10+"')");
if(x!=0){
%>
<script>

alert("New valenters registered Successfully");
</script>
<%
}
}catch(Exception e){
