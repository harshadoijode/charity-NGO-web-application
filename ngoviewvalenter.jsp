...
<table width="1076" border="0"  align="center">
  ...
  rst=stmt.executeQuery("select * from valenters where address ='"+request.getParameter("s1")+"' and ngo='"+ngo+"'");
  while(rst.next()){
...
<table width="1076" border="0"  align="center">
  ...
  rst=stmt.executeQuery("select * from valenters where ngo ='"+ngo+"'");
  while(rst.next()){
