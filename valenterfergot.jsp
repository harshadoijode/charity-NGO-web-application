...
<form  method="get" action="">
  <table width="480" border="1" align="center">
    <tr>
      <td align="right" width="199">Enter Volunteer ID number </td>
...
rst=stmt.executeQuery("select phone from valenters where id='"+request.getParameter("regno")+"' ");
if(rst.next()){
%>
...
rst=stmt.executeQuery("select password from valenters where id='"+request.getParameter("regno")+"' and phone='"+request.getParameter("answer")+"' ");
if(rst.next()){
  %>
